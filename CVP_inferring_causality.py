...
-threshold: Correlation threshold, not filtered due to the small size of the data set, is taken as 0. 
            When the number of variables is greater than 100, We suggest that a correlation threshold with an average degree of 100 should be taken.
-outfile: the directory to store the result of CVP
"""
